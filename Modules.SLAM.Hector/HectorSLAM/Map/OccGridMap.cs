...
namespace HectorSLAM.Map
{
    public class OccGridMap : GridMap
    {
        ...
        /// </summary>
        public CachedMapElement[]? cacheArray = null;

        // Variables
        public int currCacheIndex = 0;
        public int currUpdateIndex = 0;
        public int currMarkOccIndex = -1;
        public int currMarkFreeIndex = -1;

        public float oddsOccupied = 0.9f;
        public float oddsFree = 0.4f;
        public float logOddsOccupied; // The log odds representation of probability used for updating cells as occupied
        public float logOddsFree;     // The log odds representation of probability used for updating cells as free
